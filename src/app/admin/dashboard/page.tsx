      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[
          ...
          },
          {
            name: 'Bài học video',
            value: '72',
            desc: 'Thời lượng ~48 giờ',
            icon: Video,
            color: 'bg-indigo-50 text-indigo-600 border-indigo-100',
          },
          {
            name: 'Câu hỏi luyện tập',
            value: '450',
            desc: 'Trắc nghiệm & Flashcard',
            icon: HelpCircle,
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2 space-y-6 flex flex-col justify-between">
          ...
          <div className="flex justify-between items-center text-xs text-slate-500 pt-1">
            ...
            <p className="flex items-center gap-1 text-teal-600 font-bold">
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold text-sm ${user.color}`}
                  >
                    {user.initial}
                  </div>
                  <div>
