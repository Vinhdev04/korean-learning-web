...
export default function LessonDetailPage() {
  ...
  const [notes, setNotes] = useState<{ id: number; text: string; time: string }[]>([
    {
      id: 1,
      text: 'Cấu trúc N + 입니다 dùng trong văn phong trang trọng, phát biểu trước đám đông.',
      time: '01:24',
    },
    {
      id: 2,
      text: 'Phân biệt 은/는 với 이/가: 은/는 dùng khi muốn nhấn mạnh chủ thể hoặc đối chiếu.',
      time: '03:45',
    },
  ]);
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="relative aspect-video w-full rounded-3xl overflow-hidden bg-slate-950 flex flex-col justify-between p-6 shadow-xl border border-slate-800">
            ...
            <div className="flex justify-between items-center text-xs text-slate-400 font-semibold z-10">
              <span className="bg-slate-900/60 px-3 py-1 rounded-full backdrop-blur-md">
                Đang phát bài giảng video
              </span>
              <span className="bg-slate-900/60 px-3 py-1 rounded-full backdrop-blur-md">
                Độ phân giải: 1080p
              </span>
          ...
          <div>
            ...
            <p className="mt-2 text-slate-600 text-sm">
              Mục tiêu bài học: Nắm rõ cách tự giới thiệu tên, tuổi, quốc tịch và nghề nghiệp cơ bản
              bằng ngữ pháp tôn kính trang trọng nhất.
            </p>
          </div>
              ...
              <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
                <div>
                  <h4 className="font-bold text-slate-900">
                    1. Cấu trúc Danh từ + 은/는 (Tiểu từ chủ ngữ)
                  </h4>
                  <p className="mt-1 text-xs">
                    Gắn sau danh từ để biểu thị danh từ đó là chủ thể chính của câu.
                  </p>
                  <ul className="list-disc pl-5 mt-1 text-xs space-y-1">
                    <li>
                      Danh từ kết thúc bằng phụ âm (có patchim) + <strong>은</strong> (VD: 사람 + 은
                      → 사람은)
                    </li>
                    <li>
                      Danh từ kết thúc bằng nguyên âm (không patchim) + <strong>는</strong> (VD: 저
                      + 는 → 저는)
                    </li>
                  </ul>
                </div>
                ...
                <div className="border-t border-slate-100 pt-3">
                  <h4 className="font-bold text-slate-900">
                    2. Cấu trúc Danh từ + 입니다 (Là Danh từ)
                  </h4>
                  <p className="mt-1 text-xs">
                    Đuôi câu khẳng định trang trọng lịch sự nhất (cách nói tu từ trong văn viết hoặc
                    giao tiếp công sở).
                  </p>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-sm">
            ...
            <p className="text-slate-600 text-xs leading-relaxed mb-4">
              Hãy củng cố ngay các từ vựng và cấu trúc ngữ pháp vừa học qua bài tập trắc nghiệm và
