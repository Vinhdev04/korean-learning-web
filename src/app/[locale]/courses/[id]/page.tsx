    ...
    chapters: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'l5', title: 'Bài 5: Giới thiệu tên tuổi, quốc tịch (저는 ... 입니다)', duration: '16 phút' },
          { id: 'l6', title: 'Bài 6: Hỏi thăm nghề nghiệp, thông tin cá nhân', duration: '18 phút' }
        ]
      }
    ]
  },
    ...
    chapters: [
      {
        ...
        lessons: [
          { id: 'l7', title: 'Bài 1: Hỏi giá tiền và mua sắm (이것은 얼마입니까?)', duration: '20 phút' },
